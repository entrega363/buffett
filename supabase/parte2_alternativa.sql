-- PARTE 2: INSERÇÃO DE DADOS INICIAIS (VERSÃO ALTERNATIVA)
-- Use esta versão se a versão corrigida ainda apresentar problemas
...
-- Inserir algumas fotos do espaço (dados fictícios) - versão alternativa sem especificar colunas
